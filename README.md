...
instead generates an `Error` object and propagates it through the framework (either by throwing it in Koa, or passing through the `next` callback).
...
Kindly sponsored by [VietMX](https://www.maixuanviet.com)